...
contextBridge.exposeInMainWorld('ticker', {
  ...
  syncDeviceTime: () => ipcRenderer.invoke('syncDeviceTime'),
  getDeviceConfig: () => ipcRenderer.invoke('getDeviceConfig'),
  applyDeviceConfig: (v) => ipcRenderer.invoke('applyDeviceConfig', v),
